...
A [timoni.sh](http://timoni.sh) module for deploying timoni/app to Kubernetes clusters.
...
```shell
timoni -n default apply timoni/app oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni/app
```
